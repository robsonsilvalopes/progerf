...
sub print_usage {
    ...
    print <<BLOCK;
USAGE:
   perl repeatFtool.pl -q [FILE] -o [STRING] -i [INTERGER] -y [INTERGER] -r [INTERGER] -g [INTERGER] -v [INTERGER] -d [INTERGER]

DESCRIPTION:
   RepeatFinder is a tool for Simple Sequence Repeats (SSR), also called Microsatellite, characterization in any genome.

REQUIRED ARGUMENTS:
   -q [FILE]
      Input file with DNA sequence in FASTA format.
   -o [STRING]
...
EXAMPLE:
   perl repeatFinderParallelComplete.pl -q Linfantum_JPCM5.fasta -o output -i 2 -y 6 -r 5 -g 3 -v 1 -d 20
